...
import kr.co.ican.worker.action.AddWorkerAction;
...
public class ValidationCheck extends ValidationMethods{
	...
	public ValidationVO findIdValidation(MemberVO mvo , String startnum , String endnum){
	...
	public ValidationVO findPwValidation(MemberVO mvo , String startnum , String endnum){
	...
	public ValidationVO addWorkerValidation(AddWorkerAction avo){
		boolean valflag = true;
		ValidationVO vvo = new ValidationVO();
