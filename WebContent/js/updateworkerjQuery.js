...
$(function() {
	if($("select[name='im_dname']").val() != '타업체인력'){
		$("#conamelabel").hide();
...
$("#addCareers").click(function(){ //경력 row 추가 버튼
    ...
    var html = '<tr class="trappend">';
    	...
    	html +=	   '<td><input class="form-control" type="text" style="width: 100%;" name="ime_exit_date" readonly="readonly"></td>';
    	html +=    '<td><input class="form-control" type="text" style="width: 100%;" name="ime_coname"></td>';
    	html +=    '<td>';
...
//	var mailFlag = false; // 메일 중복 체크
//	var phoneFlag = false; // 폰번호 중복체크
...
//	// 메일이 달라졌을때 체크
//	if(chkemail != $("#chkmailDupl").val()){
//		$.ajax({
//			type : 'GET',
//			url : 'mailCheckDuplicate.do',
//			async: false,
...
//	}
//	// 전화번호가 달라졌을때 체크
//	if(phonenum != $("#chkphoneDupl").val()){
//		$.ajax({
//			type : 'GET',
//			url : 'phoneCheckDuplicate.do',
//			async: false,
//			data : { "ajaxphone" : phonenum },
//			
//			success : function(data) {
//				if(!data){
//					phoneFlag = true;					
